...
-- V9: Add multiple values for configuration keys that should be dropdowns
-- NOTE: This migration requires V7 to run first to remove the unique constraint on config_key
